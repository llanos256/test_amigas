...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-12-2022 a las 03:56:52
...
(9, 'David', 'Llanos', 1, 'A', 'davidllanos78@hotmail.com', '123', NULL, 0),
(10, 'Eobard', 'Thawne', 1, 'A', 'eobard@hotmail.com', '123', NULL, 0);
...
--
ALTER TABLE `test_courses_x_student`
  MODIFY `cxs_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `test_students`
--
ALTER TABLE `test_students`
  MODIFY `s_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
